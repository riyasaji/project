...
from .models import Tbl_user,Tbl_seller,Tbl_stock,Tbl_size,Tbl_category,Tbl_colour,Tbl_product,Tbl_ProductImage,Tbl_cart,Tbl_cartItem,Tbl_tailor,Tbl_payment,Tbl_wishlist,Tbl_order,Tbl_orderItem,Tbl_brand,Review,Tbl_tailorDemoProduct,Tbl_measurements
